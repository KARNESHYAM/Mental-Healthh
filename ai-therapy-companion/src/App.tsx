...
interface AuthContextType {
  ...
  loading: boolean;
  isSigningIn: boolean;
  signInCustom: (name: string, email: string, phone: string) => Promise<void>;
  logout: () => Promise<void>;
}
...
const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const signInCustom = async (name: string, email: string, phone: string) => {
  ...
  return (
    <AuthContext.Provider value={{ user: user as any, profile, loading, isSigningIn, signInCustom, logout }}>
      {children}
